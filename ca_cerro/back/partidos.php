    ...
    if (!empty($partidos)) {
        ...
        if ($proximo_partido !== null) {
            echo '<div class="proximo-partido">
                    ...
                    <div class="partido-resumen">
                        <img src="../recursos/escudos/' . htmlspecialchars($proximo_partido['equipo_local']) . '.png" alt="' . htmlspecialchars($proximo_partido['equipo_local']) . '" class="escudo">
                        <span class="vs">VS</span>
                        <img src="../recursos/escudos/' . htmlspecialchars($proximo_partido['equipo_visitante']) . '.png" alt="' . htmlspecialchars($proximo_partido['equipo_visitante']) . '" class="escudo">
                    </div>
                    <div class="partido-detalle">
